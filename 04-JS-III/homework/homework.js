...
function promedioResultadosTest(resultadosTest) {
  ...
  return suma/totaldecalificaciones
}
...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  switch (true) {
  case arguments.length===0 : return 0
  case arguments.length===1 : return arguments[0]
}
var acc=1
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
return arreglo.reduce(function (acc, elemento) {
  if (elemento > 18) {acc += 1 } 
  return acc 
},0)
}
